...
npm http GET https://registry.npmjs.org/fake-api-server/0.2.0
npm http 200 https://registry.npmjs.org/fake-api-server/0.2.0
...
fake-api-server@0.2.0 node_modules/fake-api-server
